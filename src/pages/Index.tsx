...
const MacBookMockup = () => {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto" style={{ perspective: "100rem" }}>
      ...
      >
          <div
            className="relative rounded-t-[1.5rem] sm:rounded-t-[2rem] bg-zinc-950 overflow-hidden border border-white/10"
            style={{
              aspectRatio: "16/9",
              width: "100%",
              height: "auto",
...
const Index = () => {
  ...
  /* ── Plans (i18n) ── */
  const plans = [
    { key: "start" as const, name: "Start", priceMonthly: 29, priceAnnual: 23, features: L.pricing.start.features, recommended: false },
    { key: "pro" as const, name: "Pro", priceMonthly: 79, priceAnnual: 63, features: L.pricing.pro.features, recommended: true },
    { key: "elite" as const, name: "Elite", priceMonthly: 149, priceAnnual: 119, features: L.pricing.elite.features, recommended: false },
  ];
          ...
          <Reveal>
            <div className="relative max-w-3xl mx-auto text-center rounded-3xl bg-white/[0.03] backdrop-blur-2xl border border-white/[0.08] p-12 sm:p-16">
              <div
                ...
                style={{ background: "radial-gradient(ellipse, rgba(139,92,246,0.06), transparent 60%)", filter: "blur(60px)" }}
              />
              <motion.div
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
