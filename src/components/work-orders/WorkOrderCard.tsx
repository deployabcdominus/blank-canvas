...
const getStatusConfig = (t: any) => ({
  ...
  "pending":            { bg: "rgba(107,114,128,0.12)", color: "#6b7280", label: t.workOrders.statusLabels.pending },
  ...
  "in_production":      { bg: "rgba(59,130,246,0.12)", color: "#3b82f6", label: t.workOrders.statusLabels.inProduction },
  ...
  "ready":              { bg: "rgba(16,185,129,0.12)", color: "#10b981", label: t.workOrders.statusLabels.ready },
  "done":               { bg: "rgba(16,185,129,0.12)", color: "#10b981", label: t.workOrders.statusLabels.ready },
  "completed":          { bg: "rgba(16,185,129,0.12)", color: "#10b981", label: t.workOrders.statusLabels.ready },
...
export function WorkOrderCard({
  ...
  const status = (STATUS_CONFIG as any)[statusKey] || (STATUS_CONFIG as any)["Pendiente"] || { bg: "transparent", color: "white", label: statusKey || "Pendiente" };
