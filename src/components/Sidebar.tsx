...
export const Sidebar = memo(() => {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 bottom-0 z-[100] hidden md:flex flex-col border-r border-white/[0.04] bg-zinc-950/90 lg:bg-zinc-950/80 backdrop-blur-3xl w-[72px] lg:w-[260px] px-2 lg:px-4 py-4 lg:py-6 overflow-hidden scrollbar-none shadow-2xl transition-all duration-500 will-change-transform"
      style={{ 
