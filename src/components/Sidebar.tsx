...
export const Sidebar = memo(() => {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 h-screen z-40 hidden md:flex flex-col border-r border-white/[0.04] bg-zinc-950/40 backdrop-blur-xl w-[72px] lg:w-[260px] px-2 lg:px-4 py-4 lg:py-5 overflow-y-auto overflow-x-hidden scrollbar-none"
