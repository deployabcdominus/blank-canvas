...
export const ResponsiveLayout = ({ children, title, subtitle, icon: Icon }: ResponsiveLayoutProps) => {
  ...
  return (
    <div className="flex min-h-[100dvh] bg-background text-foreground selection:bg-primary/20 relative overflow-x-hidden isolate">
      <Sidebar />
      <MobileMenu 
      ...
      <main 
        className="flex-1 transition-all duration-300 p-3 sm:p-6 ml-0 md:ml-[72px] lg:ml-[260px] w-full max-w-full min-h-[100dvh] flex flex-col pt-4 md:pt-6 relative z-0"
      >
