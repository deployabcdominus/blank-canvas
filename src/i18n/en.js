export const en = {
    ...
    landing: {
        ...
        industries: {
            ...
            subtitle: "Automatically adapts to your sector with custom labels, statuses and processes.",
            it: {
                title: "IT Services",
        ...
        features: {
            ...
            subtitle: "Features that transform your operations and give you real competitive advantage.",
            techSheet: {
        ...
        cta: {
            ...
            subtitle: "Join hundreds of businesses already managing their operations end-to-end with Sign Flow.",
            button: "Get Started Now",
            note: "Professional-grade tools · Setup in 3 minutes",
        },
        footer: {
            tagline: "The comprehensive operations management platform for service and project businesses.",
            product: "Product",
