...
export const es: TranslationKeys = {
  ...
  auth: {
    login: {
      title: "Acceso Seguro al Comando",
      subtitle: "Ingrese sus credenciales para gestionar operaciones críticas con absoluta autoridad.",
      emailLabel: "Identidad Corporativa",
      emailPlaceholder: "identidad@empresa.com",
      passwordLabel: "Llave de Seguridad",
      passwordPlaceholder: "••••••••",
      rememberMe: "Mantener Autorización",
      forgotPassword: "¿Problemas de autorización?",
      submit: "Autorizar Sesión",
      loading: "Autorizando...",
      noAccount: "¿Nuevo en el centro de mando?",
      registerLink: "Inicializar Cuenta",
      welcomeBack: "¡Bienvenido de vuelta!",
      success: "Autorización exitosa.",
      error: "Fallo de autorización",
      forgotPasswordPrompt: "Ingrese su email arriba y haga clic en '¿Problemas de autorización?'",
      emailSent: "Email Transmitido",
      emailSentDesc: "Revise su terminal para el enlace de restablecimiento.",
    },
    register: {
      title: "Inicializar Perfil de Mando",
      subtitle: "Establezca su autoridad dentro del ecosistema SignFlow.",
      fullNameLabel: "Nombre del Operador",
      fullNamePlaceholder: "Nombre Completo",
      companyNameLabel: "Entidad Empresarial",
      companyNamePlaceholder: "Su Entidad",
      emailLabel: "Canal Primario (Email)",
      emailPlaceholder: "identidad@empresa.com",
      passwordLabel: "Llave de Seguridad Maestra",
      passwordPlaceholder: "••••••••",
      confirmPasswordLabel: "Verificar Llave",
      confirmPasswordPlaceholder: "••••••••",
      submit: "Establecer Cuenta",
      creating: "Estableciendo...",
      alreadyHaveAccount: "¿Ya está autorizado?",
      loginLink: "Acceder a Terminal",
      plansTitle: "Seleccione Nivel Operativo",
      plansSubtitle: "Despliegue la configuración que coincida con su escala.",
      planPopular: "Alta Demanda",
      getPlan: "Desplegar {plan}",
      wait: "En espera...",
      month: "/mes",
      passwordsMatchError: "Las llaves de seguridad no coinciden.",
      passwordLengthError: "La llave de seguridad debe tener al menos 6 caracteres.",
      success: "¡Cuenta Establecida!",
      successDesc: "Bienvenido al Centro de Mando SignFlow.",
    }
  },
