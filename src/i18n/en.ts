export const en = {
  ...
  landing: {
    ...
    pricing: {
      ...
      titleLine2: "pricing for every stage",
      subtitle: "Choose the plan that fits your growth. No hidden fees, no long-term contracts.",
      monthly: "Monthly",
      annual: "Annual Billing",
      save20: "Get 2 months for free",
      perMonth: "/mo",
      billedAnnually: "Billed annually",
      mostPopular: "Best Value",
      chosenBy: "The choice for high-performing teams",
      choose: "Select Plan",
    ...
    pageTransitions: {
      title: "Page Transitions Implementation",
      objective: "Develop a dynamic and visually attractive page transition system for a web application.",
      features: {
        effects: "Transition Effects: Implement a variety of modern and smooth transition effects between pages, such as:",
        fade: "Fade In/Out",
        slide: "Slide (left/right/up/down)",
        zoom: "Zoom In/Out",
        flip: "Flip (horizontal/vertical)",
        parallax: "Parallax",
        custom: "Custom effects (to be defined)",
        configurability: "Configurability: Allow configuration of parameters for each transition, such as:",
        duration: "Duration",
        easing: "Acceleration curve (easing)",
        direction: "Direction",
        opacity: "Opacity",
        optimization: "Optimization: Ensure transitions are performant and don't cause bottlenecks in the user experience, using techniques like hardware acceleration when possible.",
        compatibility: "Compatibility: Ensure compatibility with all modern browsers.",
        integration: "Integration: Facilitate integration with existing JavaScript frameworks or be an independent solution.",
      },
      technical: {
        title: "Technical Requirements",
        tech: "Use modern web technologies (HTML5, CSS3, JavaScript).",
        libs: "Preferably use efficient animation libraries or frameworks (e.g., GSAP, Anime.js, Framer Motion).",
        accessibility: "Consider accessibility and impact on users with motion sensitivity.",
      },
      steps: {
        title: "Necessary Steps",
        research: "Research and Tools Selection: Identify and select the most suitable animation libraries/frameworks.",
        architecture: "Architecture Definition: Design the code structure to manage transitions in a modular and scalable way.",
        implementation: "Effects Implementation: Code different transition effects, starting with common ones.",
        interface: "Config Interface (Optional): Develop an interface to manage transition settings.",
        testing: "Testing and Optimization: Perform rigorous testing across different browsers and devices.",
        documentation: "Documentation: Document usage and configuration.",
      }
    },
    seo: {
    ...
    pilot: {
      ...
      growthStats: "Growth Metrics",
      operationsChecklist: "Operations Checklist",
      operationsChecklistDesc: "Track core workflows to ensure they are ready for real usage.",
      aboutPilot: "About the Pilot",
      aboutPilotDesc: "The goal of this pilot is to process 5-10 real jobs from start to finish. This will validate the entire workflow from lead intake to final project closing.",
      successMetrics: "Success Metrics",
      metricZeroBugs: "Zero critical blocking bugs",
      metricOrdersPrinted: "All production orders printed correctly",
      metricPhotosUploaded: "Installation photos uploaded successfully",
      metricPaymentsRecorded: "Payments recorded accurately",
      metricReferralActive: "Referral program active and generating leads",
      intelligence: "Intelligence",
      profitability: "Profitability",
      marginOptimization: "Margin Optimization",
      predictivePricing: "Predictive Pricing",
      efficiencyScore: "Efficiency Score",
      projectROI: "Project ROI",
      phase8Title: "Phase 8: Growth Engine",
      phase8Desc: "Marketing automation infrastructure is now provisioned. Connect your delivery providers to start automated campaigns.",
      phase8ComingSoon: "Campaign designer and referral link generator coming in the next update.",
      phase9Title: "Phase 9: Predictive Intelligence",
      phase9Desc: "Predictive intelligence infrastructure has been deployed. The system now tracks actual vs estimated costs to suggest optimal margins.",
      phase9ComingSoon: "Cost tracking and automated margin suggestions will populate as you complete work orders.",
      phase10Title: "Phase 10: API & Ecosystem",
      phase11Title: "Phase 11: White-Label Client Portal",
      portalPreview: "Portal Customization Preview",
      portalPreviewDesc: "Upload your branding in Company Settings to preview your white-label portal.",
      stage13Active: "Phase 13: Autonomous AI & Enterprise SSO (Active)",
      remainingStagesTitle: "Remaining Strategic Plan Stages",
      stage10: "Phase 10: Ecosystem Integrations & Open API",
      stage11: "Phase 11: White-Label Client Portal & Collaboration",
      stage12: "Phase 12: Global Scaling & Multi-Region Infrastructure",
      stageCompletion: "Core operation completion and mass market readiness",
      ...
      phase10Desc: "Open API and integrations infrastructure has been deployed. You can now connect SignFlow with your external tools and automate workflows via Webhooks.",
      phase11Desc: "White-Label Client Portal infrastructure has been deployed. Your clients can now access their projects, sign documents, and collaborate in real-time under your own brand.",
      ...
      uptime: "Uptime",
      multiRegionSync: "Multi-Region Sync",
      phase12Desc: "Global scaling infrastructure has been activated. The system now supports multi-region deployments, latency-based routing, and geographic data isolation for local regulatory compliance.",
      mobile: "Mobile & AI",
      ...
      phase13Desc: "The Autonomous Intelligence Ecosystem and Enterprise SSO infrastructure have been deployed. The system now supports voice transcription for field technicians and advanced corporate authentication.",
      submitFeedback: "Submit Pilot Feedback",
      submitFeedbackDesc: "Found a bug or have a suggestion? Tell us here.",
      issueHistory: "Pilot Issue History",
