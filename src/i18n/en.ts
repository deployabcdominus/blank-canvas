export const en = {
  ...
  auth: {
    login: {
      ...
      subtitle: "Enter your credentials to manage mission-critical operations with absolute authority.",
      emailLabel: "Corporate Identity",
      emailPlaceholder: "identity@enterprise.com",
      passwordLabel: "Security Key",
      passwordPlaceholder: "••••••••",
      rememberMe: "Maintain Authorization",
      forgotPassword: "Authorization problems?",
      submit: "Authorize Session",
      loading: "Authorizing...",
      noAccount: "New to the command center?",
      registerLink: "Initialize Account",
      welcomeBack: "Welcome back!",
      success: "Authorization successful.",
      error: "Authorization failed",
      forgotPasswordPrompt: "Enter your email above and click 'Authorization problems?'",
      emailSent: "Email Transmitted",
      emailSentDesc: "Check your terminal for the reset link.",
    },
    register: {
      title: "Initialize Command Profile",
      subtitle: "Establish your authority within the SignFlow ecosystem.",
      fullNameLabel: "Full Operator Name",
      fullNamePlaceholder: "Full Name",
      companyNameLabel: "Enterprise Entity",
      companyNamePlaceholder: "Your Entity",
      emailLabel: "Primary Channel (Email)",
      emailPlaceholder: "identity@enterprise.com",
      passwordLabel: "Master Security Key",
      passwordPlaceholder: "••••••••",
      confirmPasswordLabel: "Verify Key",
      confirmPasswordPlaceholder: "••••••••",
      submit: "Establish Account",
      creating: "Establishing...",
      alreadyHaveAccount: "Already authorized?",
      loginLink: "Access Terminal",
      plansTitle: "Select Operational Tier",
      plansSubtitle: "Deploy the configuration that matches your scale.",
      planPopular: "High Demand",
      getPlan: "Deploy {plan}",
      wait: "Standby...",
      month: "/mo",
      passwordsMatchError: "Security keys do not match.",
      passwordLengthError: "Security key must be at least 6 characters.",
      success: "Account Established!",
      successDesc: "Welcome to the SignFlow Command Center.",
    }
  },
